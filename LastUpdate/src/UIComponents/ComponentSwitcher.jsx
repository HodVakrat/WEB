...
function ComponentSwitcher() {
    ...
    const renderContent = () => {
        switch (activeComponent) {
            ...
            case 'parent':
                return <ParentScreen parent={currentParent} onEnterProfile={handleEnterProfile} onParentUpdated={handleParentUpdated} onNavigate={handleNavigate} />;
            case 'dashboard':
                return <MathDashboard profile={activeProfile} onNavigate={handleNavigate} />;
            case 'quiz':
